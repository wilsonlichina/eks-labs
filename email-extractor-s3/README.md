...
docker buildx create --name multiarch-builder --driver docker-container --bootstrap --platform linux/amd64,linux/arm64,linux/arm/v7,linux/arm/v6,linux/ppc64le,linux/s390x,linux/386,linux/riscv64
